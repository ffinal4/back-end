...
public class QGoods extends EntityPathBase<Goods> {
    ...
    public final EnumPath<com.example.peeppo.domain.goods.enums.GoodsStatus> goodsStatus = createEnum("goodsStatus", com.example.peeppo.domain.goods.enums.GoodsStatus.class);
    ...
    public final EnumPath<com.example.peeppo.domain.goods.enums.RequestedStatus> requestedStatus = createEnum("requestedStatus", com.example.peeppo.domain.goods.enums.RequestedStatus.class);
