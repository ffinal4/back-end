...
public class DibsController {
    ...
    @PostMapping("/dibs")
    public ApiResponse<CheckResponseDto> dibsGoods(@AuthenticationPrincipal UserDetailsImpl userDetails,
                                                                              @Valid @RequestBody DibsRequestDto dibsRequestDto) {
        return ResponseUtils.ok(dibsService.dibsGoods(userDetails, dibsRequestDto));
    }
